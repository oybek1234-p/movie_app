...
import com.mytaxi.adapter.SportCategoryAdapter;
...
public class SportCategoryFragment extends Fragment {
    ...
    private SportCategoryAdapter adapter;
    ...
    private void getCategory() {
        ...
        if(getContext() != null) {
            ...
            client.post(getContext(), Constant.SPORT_CATEGORY_URL, params, new AsyncHttpResponseHandler() {
                @Override
                public void onStart() {
                    super.onStart();
                    showProgress(true);
    ...
    private void displayData() {
        if (mListItem.size() == 0) {
            ...
            adapter = new SportCategoryAdapter(getActivity(), mListItem);
