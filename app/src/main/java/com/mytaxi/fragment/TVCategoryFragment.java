...
import com.mytaxi.adapter.TVCategoryAdapter;
import com.mytaxi.item.ItemTVCategory;
...
public class TVCategoryFragment extends Fragment {
    ...
    private void getCategory() {
        ...
        if(getContext() != null) {
            ...
            client.post(getContext(), Constant.TV_CATEGORY_URL, params, new AsyncHttpResponseHandler() {
                @Override
                public void onStart() {
                    super.onStart();
                    showProgress(true);
