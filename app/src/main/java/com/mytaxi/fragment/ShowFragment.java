...
import com.mytaxi.adapter.ShowAdapter;
...
public class ShowFragment extends Fragment {
    ...
    private void getShow(String mFilter) {
        ...
        if(getContext() != null) {
            ...
            client.post(getContext(), isLanguage ? Constant.SHOW_BY_LANGUAGE_URL : Constant.SHOW_BY_GENRE_URL, params, new AsyncHttpResponseHandler() {
                @Override
                public void onStart() {
                    super.onStart();
                    if (isFirst)
