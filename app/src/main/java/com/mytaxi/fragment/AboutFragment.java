...
import com.mytaxi.item.ItemAbout;
...
public class AboutFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mMKLoader = rootView.findViewById(R.id.progressBar);
    ...
    private void getAboutUs() {
        ...
        if(getContext() != null) {
            ...
            client.post(getContext(), Constant.APP_DETAIL_URL, params, new AsyncHttpResponseHandler() {
                @Override
                public void onStart() {
                    super.onStart();
