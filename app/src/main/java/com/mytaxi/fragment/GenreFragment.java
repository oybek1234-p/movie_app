...
import com.mytaxi.adapter.GenreAdapter;
...
public class GenreFragment extends Fragment implements FilterDialog.FilterDialogListener {
    ...
    private boolean isVisible = true, isLoaded = false;
    ...
    public static GenreFragment newInstance(boolean isShow, int position) {
