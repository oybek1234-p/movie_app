...
public class EditProfileFragment extends Fragment implements Validator.ValidationListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.cander_activity_edit_profile, container, false);
        ...
        nameView = rootView.findViewById(R.id.user_name);
        myApplication = MyApplication.getInstance();


        progressBar = rootView.findViewById(R.id.loadingLayout);
    ...
    private void getUserProfile() {
        ...
        if(getContext() != null) {
            ...
            client.post(getContext(), Constant.PROFILE_URL, params, new AsyncHttpResponseHandler() {
    ...
    private void putEditProfile() {
        ...
        if(getContext() != null) {
            ...
            client.post(getContext(), Constant.EDIT_PROFILE_URL, params, new AsyncHttpResponseHandler() {
