...
import com.mytaxi.adapter.LanguageAdapter;
import com.mytaxi.dialog.FilterDialog;
import com.mytaxi.item.ItemLanguage;
...
public class LanguageFragment extends Fragment implements FilterDialog.FilterDialogListener {
    ...
    private void getLanguage() {
        ...
        if(getContext() != null) {
            ...
            client.post(getContext(), Constant.LANGUAGE_URL, params, new AsyncHttpResponseHandler() {
                @Override
                public void onStart() {
                    super.onStart();
                    showProgress(true);
