...
public class RelatedShowsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RelatedShowsAdapter(Context context, ArrayList<ItemShow> dataList, boolean isHomeMore) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.related_shows_item_cander, parent, false);
