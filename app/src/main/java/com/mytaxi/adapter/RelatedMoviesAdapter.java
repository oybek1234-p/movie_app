...
public class RelatedMoviesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RelatedMoviesAdapter(Context context, ArrayList<ItemMovie> dataList, boolean isHomeMore) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.related_movies_item_cander, parent, false);
