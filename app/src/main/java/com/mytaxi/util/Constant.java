...
import com.mytaxi.apps.BuildConfig;
...
public class Constant implements Serializable {
    ...
    public static final String GET_SELCOM_URL = API_URL + "get_selcom_url";
    public static final String SELCOM_PAYMENT_STATUS = API_URL + "selcom_payment_status";
    ...
    public static final String SELCOM_ON = "selcom_payment_on_off";
    public static final String SELCOM_API_KEY = "selcom_api_key";
    public static final String SELCOM_SECRET_KEY = "selcom_secret_key";
    public static final String FLUTTERWAVE_ON = "flutterwave_payment_on_off";
    public static final String FLUTTERWAVE_PUBLIC_KEY = "flutterwave_public_key";
    public static final String FLUTTERWAVE_ENC_KEY = "flutterwave_enc_key";
    public static final String FLUTTERWAVE_MODE = "flutterwave_mode";
    ...
    public static final String SELCOM_URL = "selcom_url";
